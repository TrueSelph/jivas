...
export function meta() {
	return [{ title: "Add Action | JIVAS Manager" }];
}
...
export async function clientLoader({ request }: Route.ClientLoaderArgs) {
	...
	const packageType = url.searchParams.get("type") || "action";
...
export default function NewAction({ loaderData }: Route.ComponentProps) {
	const host = localStorage.getItem("jivas-host");
	...
	const installActionFetcher = useFetcher();
	...
	return (
		<Box py="xl" px="xl">
			<Group>
				<ActionIcon color="dark" size="sm" component={Link} to="/actions">
					<IconArrowLeft />
				</ActionIcon>
				<Title order={3}>Add Action</Title>
			</Group>
			...
			<Card h="80vh" px="xs" withBorder>
				<Paper p="md" radius="md" h="100%">
					<Title order={3}>Browse Actions</Title>
								...
								<Box>
									...
									<Group justify="end" mt="lg">
										<Button
											...
											loading={installActionFetcher.state !== "idle"}
											color="dark"
										>
											Install Action
										</Button>
